...
class SearchContentWithLanguageFilterMeasurer extends AbstractMeasurer {
    ...
    private function load(ValueObject $valueObject)
    {
        ...
        $fieldFilters = array();
        $fieldFilters['languages'] = array('eng-GB', 'ger-DE', 'dan-DK', 'cze-CZ');
    ...
    {
        return "SearchService::findContent using current language (Query -> Objects)";
    }
